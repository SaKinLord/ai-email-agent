        ...
        try: # Wrap processing in a try block
            ...
            # --- *** NEW: Implement manage_meetings *** ---
                ...
                try:
                    ...
                    query = self.db.collection(EMAILS_COLLECTION)\
                              .where('llm_purpose', '==', 'Meeting Invite')\
